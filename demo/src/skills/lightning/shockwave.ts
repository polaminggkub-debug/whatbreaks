...
export function executeShockwave(input: ShockwaveInput) {
...
export function getStatusEffect(): StatusEffect | null {
  return { type: 'stun', element: SKILL_ELEMENT, damagePerTurn: 0, duration: 1, stackable: false };
}
