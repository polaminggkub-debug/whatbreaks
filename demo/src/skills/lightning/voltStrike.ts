...
export function executeVoltStrike(input: VoltStrikeInput) {
...
export function getStatusEffect(): StatusEffect | null {
  return { type: 'shock', element: SKILL_ELEMENT, damagePerTurn: 12, duration: 2, stackable: true };
}
