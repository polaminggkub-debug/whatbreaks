...
export const SKILL_NAME = 'Tornado';
export const SKILL_ELEMENT = 'wind' as const;
export const BASE_DAMAGE = 75;
...
export function executeTornado(input: TornadoInput) {
...
export function getStatusEffect(): StatusEffect | null {
  return { type: 'blind', element: SKILL_ELEMENT, damagePerTurn: 0, duration: 2, stackable: false };
}
