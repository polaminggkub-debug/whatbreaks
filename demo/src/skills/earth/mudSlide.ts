...
export function executeMudSlide(input: MudSlideInput) {
...
export function getStatusEffect(): StatusEffect | null {
  return { type: 'slow', element: SKILL_ELEMENT, damagePerTurn: 0, duration: 3, stackable: true };
}
