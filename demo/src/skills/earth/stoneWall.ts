...
export const SKILL_NAME = 'StoneWall';
export const SKILL_ELEMENT = 'earth' as const;
export const BASE_DAMAGE = 25;
export const MANA_COST = 20;
export const COOLDOWN = 1;

export interface StoneWallInput {
...
export function executeStoneWall(input: StoneWallInput) {
...
export function getStatusEffect(): StatusEffect | null {
  return { type: 'weaken', element: SKILL_ELEMENT, damagePerTurn: 0, duration: 3, stackable: true };
}
