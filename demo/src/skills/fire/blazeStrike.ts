...
export const SKILL_NAME = 'BlazeStrike';
export const SKILL_ELEMENT = 'fire' as const;
export const BASE_DAMAGE = 70;
export const MANA_COST = 50;
export const COOLDOWN = 3;

export interface BlazeStrikeInput {
...
export function executeBlazeStrike(input: BlazeStrikeInput) {
