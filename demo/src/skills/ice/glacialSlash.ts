...
export const SKILL_NAME = 'GlacialSlash';
export const SKILL_ELEMENT = 'ice' as const;
export const BASE_DAMAGE = 50;
export const MANA_COST = 30;
export const COOLDOWN = 2;

export interface GlacialSlashInput {
...
export function executeGlacialSlash(input: GlacialSlashInput) {
...
export function getStatusEffect(): StatusEffect | null {
  return { type: 'freeze', element: SKILL_ELEMENT, damagePerTurn: 0, duration: 1, stackable: false };
}
