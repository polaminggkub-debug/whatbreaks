...
export function executeBlizzard(input: BlizzardInput) {
...
export function getStatusEffect(): StatusEffect | null {
  return { type: 'freeze', element: SKILL_ELEMENT, damagePerTurn: 0, duration: 3, stackable: false };
}
