...
export function executeIceSpear(input: IceSpearInput) {
...
export function getStatusEffect(): StatusEffect | null {
  return { type: 'slow', element: SKILL_ELEMENT, damagePerTurn: 0, duration: 2, stackable: true };
}
