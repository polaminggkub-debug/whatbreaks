...
export const SKILL_NAME = 'Freeze';
...
export function executeFreeze(input: FreezeInput) {
...
export function getStatusEffect(): StatusEffect | null {
  return { type: 'freeze', element: SKILL_ELEMENT, damagePerTurn: 0, duration: 4, stackable: false };
}
